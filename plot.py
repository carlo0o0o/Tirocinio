...
def get_values(dataroot, key):
    npzs = list(glob(join(dataroot, '*', 'results.npz')))   #cera 
    vals = []
    for f in npzs:
...
subj_acc = np.load('results/20190313T101236Z.LGJL/subj_acc.npz')
...
data = np.load('results/20190313T101236Z.LGJL/results.npz')
