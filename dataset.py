...
def to_dataframe(dataroot):
    ...
    # Load data from the three training foldss
...
TF_TRAIN = transforms.Compose([
    ...
    #transforms.RandomResizedCrop(300, scale=(0.8, 1.0)),                              #aggiunto
    transforms.RandomVerticalFlip(),
    #transforms.RandomHorizontalFlip(),
    #transforms.RandomRotation(degrees=45),                                            #aggiunto
    #transforms.ColorJitter(brightness=0.2, contrast=0.2, saturation=0.2, hue=0.1),    #aggiunto
    #transforms.GaussianBlur(kernel_size=(5, 9), sigma=(0.1, 5)),                      #aggiunto
    #transforms.RandomAffine(degrees=360, translate=(0.2, 0.2)),
    #transforms.Lambda(tf_rotation_stack), NON FUNZIONA
    transforms.ToTensor(),
]) 
...
TF_VALID_ROT = transforms.Compose([
    transforms.CenterCrop(300),
    #transforms.ColorJitter(brightness=0.1, contrast=0.1, saturation=0.1, hue=0.05),  #aggiunto
